...
#include "GetCidKeysComponentProgramProvider.hpp"
...
//#component
class GetCidKeysComponent : public ComponentBase, public ProgramComponentBase, private Loggable<GetCidKeysComponent>
{
public: // typedefs

public: // construction/destruction
#if ARP_ABI_VERSION_MAJOR < 2
    GetCidKeysComponent(IApplication& application, const String& name);
    virtual ~GetCidKeysComponent() = default;
#else
    GetCidKeysComponent(ILibrary& library, const String& name);
#endif
...
private: // methods
#if ARP_ABI_VERSION_MAJOR < 2
    GetCidKeysComponent(const GetCidKeysComponent& arg) = delete;
    GetCidKeysComponent& operator= (const GetCidKeysComponent& arg) = delete;
...
private: // fields
    GetCidKeysComponentProgramProvider programProvider;
...
#if ARP_ABI_VERSION_MAJOR < 2
inline IComponent::Ptr GetCidKeysComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new GetCidKeysComponent(application, name));
}
#endif
